    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                <li>
                    <a href="https://www.linkedin.com/in/richmond-mensah-osei-287675275/" className="hover:underline me-4 md:me-6"><LinkedIn /></a>
                </li>
                <li>
                    <a href="https://twitter.com/_aristodev" className="hover:underline me-4 md:me-6"><Twitter /></a>
                </li>
                <li>
                    <a href="https://github.com/aristo-13" className="hover:underline me-4 md:me-6"><GitHub /></a>
                </li>
            </ul>
        </div>
